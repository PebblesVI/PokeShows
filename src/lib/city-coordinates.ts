...
const CITY_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  // Card show cities (backfill coverage)
  'morgantown|WV': { lat: 39.6295, lng: -79.9559 },
  'vienna|WV': { lat: 39.3270, lng: -81.5485 },
  'bridgeport|WV': { lat: 39.2865, lng: -80.2562 },
  'council bluffs|IA': { lat: 41.2619, lng: -95.8608 },
  'flint|MI': { lat: 43.0125, lng: -83.6875 },
  'langhorne|PA': { lat: 40.1746, lng: -74.9226 },
  'placentia|CA': { lat: 33.8722, lng: -117.8703 },
  'camp hill|PA': { lat: 40.2398, lng: -76.9197 },
  'chesterfield township|MI': { lat: 42.6709, lng: -82.8360 },
  'glen burnie|MD': { lat: 39.1626, lng: -76.6247 },
  'mattoon|IL': { lat: 39.4831, lng: -88.3726 },
  'springdale|AR': { lat: 36.1867, lng: -94.1288 },
  'springfield|PA': { lat: 39.9301, lng: -75.3204 },
  'st paul|MN': { lat: 44.9537, lng: -93.0900 },
  'allen|TX': { lat: 33.1032, lng: -96.6706 },
  'apopka|FL': { lat: 28.6934, lng: -81.5322 },
  'asheville|NC': { lat: 35.5951, lng: -82.5515 },
  'babylon|NY': { lat: 40.6957, lng: -73.3257 },
  'cape canaveral|FL': { lat: 28.3922, lng: -80.6077 },
  'clifton park|NY': { lat: 42.8585, lng: -73.7985 },
  'fairfax|VA': { lat: 38.8462, lng: -77.3064 },
  'farmingdale|NJ': { lat: 40.1960, lng: -74.1688 },
  'federal way|WA': { lat: 47.3223, lng: -122.3126 },
  'fountain valley|CA': { lat: 33.7092, lng: -117.9536 },
  'freehold|NJ': { lat: 40.2604, lng: -74.2735 },
  'glenpool|OK': { lat: 35.9551, lng: -96.0064 },
  'hagerstown|MD': { lat: 39.6418, lng: -77.7200 },
  'iselin|NJ': { lat: 40.5751, lng: -74.3224 },
  'lewisville|TX': { lat: 33.0462, lng: -96.9942 },
  'livonia|MI': { lat: 42.3684, lng: -83.3527 },
  'mandeville|LA': { lat: 30.3583, lng: -90.0684 },
  'new britain|CT': { lat: 41.6612, lng: -72.7795 },
  'north attleboro|MA': { lat: 41.9715, lng: -71.3228 },
  'old bridge|NJ': { lat: 40.4151, lng: -74.3654 },
  'oxford|MI': { lat: 42.8245, lng: -83.2647 },
  'parsippany|NJ': { lat: 40.8578, lng: -74.4260 },
  'peoria|IL': { lat: 40.6936, lng: -89.5890 },
  'port saint lucie|FL': { lat: 27.2730, lng: -80.3582 },
  'port st. lucie|FL': { lat: 27.2730, lng: -80.3582 },
  'rapid city|SD': { lat: 44.0805, lng: -103.2310 },
  'spartanburg|SC': { lat: 34.9496, lng: -81.9320 },
  'springfield|GA': { lat: 32.3721, lng: -81.3112 },
  'troy|OH': { lat: 40.0395, lng: -84.2033 },
  'uncasville|CT': { lat: 41.4345, lng: -72.1079 },
  'venice|FL': { lat: 27.0998, lng: -82.4543 },
  'waltham|MA': { lat: 42.3765, lng: -71.2356 },
  'west allis|WI': { lat: 43.0167, lng: -88.0070 },
  'westlake|OH': { lat: 41.4553, lng: -81.9179 },
  'grapevine|TX': { lat: 32.9343, lng: -97.0781 },
  'hebron|KY': { lat: 39.0662, lng: -84.7030 },
  'palm springs|FL': { lat: 26.6356, lng: -80.0962 },
  'west warwick|RI': { lat: 41.6968, lng: -71.5218 },
  'strongsville|OH': { lat: 41.3145, lng: -81.8357 },
  'fairfield|NJ': { lat: 40.8826, lng: -74.3065 },
  'east islip|NY': { lat: 40.7320, lng: -73.1857 },
  'normal|IL': { lat: 40.5142, lng: -88.9906 },
  'port huron|MI': { lat: 42.9709, lng: -82.4249 },
  'marlette|MI': { lat: 43.3272, lng: -83.0808 },
  'cadillac|MI': { lat: 44.2519, lng: -85.4016 },
  'kennewick|WA': { lat: 46.2112, lng: -119.1372 },
  'saginaw|MI': { lat: 43.4195, lng: -83.9508 },
  'sturgeon bay|WI': { lat: 44.8341, lng: -87.3770 },
